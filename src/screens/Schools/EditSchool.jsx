...
const EditSchool = memo(({ route }) => {
  const navigation = useNavigation();
  const { top } = useSafeAreaInsets();
  const { item } = route.params;
  const [updateSchool, { isLoading: isUpdating, error, isSuccess, isError }] = useUpdateSchoolMutation();
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.txtCreateAccount}>Edit School</Text>
