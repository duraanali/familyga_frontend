...
const EditDoctor = memo(({ route }) => {
  const navigation = useNavigation();
  const { top } = useSafeAreaInsets();
  const { item } = route.params;
  const [updateDoctor, { isLoading: isUpdating, error, isSuccess, isError }] = useUpdateDoctorMutation();
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.txtCreateAccount}>Edit Doctor</Text>
...
<Controller
 ...
 {listHospitalsData && (
      ...
      <View style={styles.buttonView}>
        <ButtonPrimary title={"Edit School"} onPress={handleSubmit(onSubmit)} />
      </View>
    </View>
  );
});
