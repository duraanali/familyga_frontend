...
const AddTeacher = memo(() => {
  ...
  const [createTeacher, { isSuccess, isError, error }] = useCreateTeacherMutation();
  ...
  useEffect(() => {
    if (isSuccess) {
      ...
      Alert.alert(
        "Update Error",
        error.data?.message || "Failed to add Teacher."
      );
      setShowError(true);
    }
  ...
  const onSubmit = useCallback(
    (data) => {
        setIsLoading(true);
        createTeacher(data).unwrap();
        setIsLoading(false);
        navigation.navigate(ROUTES.Teachers);
    },
    [createTeacher, setIsLoading]
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.txtCreateAccount}>Add New Teacher</Text>
...
<Controller
   ...
   {listSchoolsData && (
      ...
      <View style={styles.buttonView}>
        <ButtonPrimary title={"Add Teacher"} onPress={handleSubmit(onSubmit)} />
      </View>
    </View>
  );
});
