...
const EditHospital = memo(({ route }) => {
  const navigation = useNavigation();
  const { top } = useSafeAreaInsets();
  const { item } = route.params;
  const [updateHospital, { isLoading: isUpdating, error, isSuccess, isError }] = useUpdateHospitalMutation();
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.txtCreateAccount}>Edit Hospital</Text>
     ...
     <Controller
      ...
      <View style={styles.buttonView}>
        <ButtonPrimary title={"Edit Hospital"} onPress={handleSubmit(onSubmit)} />
      </View>
    </View>
  );
});
